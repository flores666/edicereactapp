...
export function RegisterForm() {
    ...
    const onSubmit = async (data: TRegisterForm) => {
        const result = await auth.actions.authRegister(data);
        ...
        if (result.isSuccess) {
            ...
            addNotification(result.message ?? 'Ошибка регистрации', isNullOrEmpty(result.reason) ? NotificationTypes.Error : NotificationTypes.Info);
        }
    };
